...
class WashGlassWithAmount extends StatelessWidget {
  const WashGlassWithAmount({
    Key key,
...
class ProgressCircle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final observable = Observable.combineLatest2<int, int, double>(userbloc.outMaxcovid, washBloc.outWashsAmount, (
      maxcovid,
      consumedcovid,
    ) {
      return consumedcovid / maxcovid;
    });
